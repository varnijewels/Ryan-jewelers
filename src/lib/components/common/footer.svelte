...
<!-- ryans-jewels runs its own #fafafa band straight up against the
     Instagram strip, so it must not carry the default top margin. -->
<div class={activeThemeName === 'ryans-jewels' ? '' : 'mt-5'}>
