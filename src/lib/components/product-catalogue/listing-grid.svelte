...
<style>
	.rj-listing-grid { gap: 30px 24px; grid-template-columns: repeat(3, minmax(0, 1fr)); }
	.rj-listing-list { grid-template-columns: 1fr; }
	@media (min-width: 1600px) { .rj-listing-grid:not(.rj-listing-list) { grid-template-columns: repeat(4, minmax(0, 1fr)); } }
	@media (max-width: 1100px) { .rj-listing-grid:not(.rj-listing-list) { grid-template-columns: repeat(3, minmax(0, 1fr)); } }
	@media (max-width: 767px) { .rj-listing-grid:not(.rj-listing-list) { grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 24px 12px; } }
</style>
